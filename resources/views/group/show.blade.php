...
<div class="bg-white shadow px-10 mb-5">
    <div class="py-5">
        <a class="text-sm mb-3 font-medium flex items-center gap-2 text-blue-600 hover:text-blue-800 transition" href="{{ route('group.index',['id' => $group->id_mod]) }}">
        ...
        <div class="md:flex md:justify-between md:items-start">
            <div>
                ...
                <p class="text-zinc-500 font-light text-sm mb-2">publié le {{ $group->start_at->format('d M Y H:i') }}</p>        
            </div>
